...
function Hero() {
    ...
    return (
        <div
            ...
            >
            <motion.h1 initial={{opacity:0,x:-300}} animate={{x:0,opacity:1}} transition={{duration: duration}} className='text-[70px] max-md:text-[50px] text-purple-600'>Hi. i am Youssef</motion.h1>
